...
transform = transforms.Compose([
    ...
    transforms.ToTensor(),
    transforms.Normalize((0.4564, 0.4952, 0.4535), (0.2713, 0.1964, 0.2121)),
])
...
plt.figure()
plt.scatter(low_dim_data_pca[:, 0], low_dim_data_pca[:, 1], alpha=0.5, c='r')
plt.title("PCA")
plt.show()
plt.savefig("pca.png")
...
plt.figure()
plt.scatter(low_dim_data_tsne[:, 0], low_dim_data_tsne[:, 1], alpha=0.5, c='r')
plt.title("t-SNE")
plt.show()
